        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <button
              ...
              className={`card-modern p-8 text-left transition-all ${donationType === 'general'
            ...
            <button
              ...
              className={`card-modern p-8 text-left transition-all ${donationType === 'zakat'
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4 mb-6">
              {presetAmounts.map((preset) => (
                <button
                  ...
                  className={`py-4 rounded-xl font-bold text-lg transition-all ${amount === preset
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <button
                    ...
                    className={`py-3 rounded-xl font-semibold transition-all ${frequency === 'one-time'
                  ...
                  <button
                    ...
                    className={`py-3 rounded-xl font-semibold transition-all ${frequency === 'monthly'
                      ? 'bg-islamic-gold text-white shadow-lg'
                      : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`py-3 rounded-xl font-semibold transition-all ${frequency === 'yearly'
                      ? 'bg-islamic-gold text-white shadow-lg'
                      : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                      }`}
                  >
